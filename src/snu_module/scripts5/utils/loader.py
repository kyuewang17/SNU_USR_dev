...
def argument_parser(logger, script_name, dev_version=None, mode_selection=None):
    ...
    parser = argparse.ArgumentParser(
        prog=script_name, description="Outdoor Surveillance Robot Object Recognition Module developed by SNU"
    )
    if dev_version is not None:
        parser.add_argument(
            "--dev-version", "-V", default=dev_version,
            help="Integrated Module Development Version"
        )
    else:
        parser.add_argument(
            "--dev-version", "-V",
