...
class detector_options(object):
    def __init__(self, device=0):
        self.model_dir = os.path.join(model_base_path, "detection_model")
        self.device = device
        ...
        self.postproc_args = {
            ...
            # 'nms_thresh': 0.5, 'conf_thresh': 0.5,
...
class sensor_options(object):
    def __init__(self):
        ...
        self.infrared = {
            ...
            "rostopic_name": "/osr/__image_ir",
            "camerainfo_rostopic_name": "/osr/__image_ir_camerainfo",
        }
        self.thermal = {
            "imgmsg_to_cv2_encoding": "8UC1",
            "rostopic_name": "/osr/__image_thermal",
        }
        self.nightvision = {
            "imgmsg_to_cv2_encoding": "8UC3",
            "rostopic_name": "/osr/__image_nv1",
        }
        self.odometry = {
