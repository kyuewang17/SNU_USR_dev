...
def project_point_cloud(velodyne_link, img_msg, image_pub):
    ...
    try:
        transform = TF_BUFFER.lookup_transform('rgb_frame', 'velodyne_frame_from_rgb', rospy.Time())    #get transform parameter from rgb_frame to velodyne_frame
...
if __name__ == '__main__':
    ...
    image_color = "/osr/image_color"
    velodyne_points = "/osr/lidar_pointcloud"
    camera_lidar = "/camera_lidar" #output topic name
    PROJECT_MODE = "true"
